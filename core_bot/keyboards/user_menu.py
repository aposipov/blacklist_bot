...
edit_bd = InlineKeyboardButton(text="❌ изменить Дату Рождения", callback_data="edit_bd")
edit_id = InlineKeyboardButton(text="❌ изменить Номер ВУ", callback_data="edit_id")
